...
\red{Una tesis o informe no lleva prefacio. Las aclaraciones sobre las actividades y publicaciones las puedes incluir al final de la sección de introducción, antes de presentar la estructura del documento}

Este trabajo se desarrolló en el marco de actividades de investigación y desarrollo vinculadas al estudio numérico de aglomerados auto-gravitantes en cuerpos menores del Sistema Solar (Small Solar System Bodies, SSSB) \red{sacar sigla, no se usa más que una vez}. Durante su ejecución se obtuvieron hitos académicos y de difusión asociados al proyecto.
...
El Método de Elementos Discretos (Discrete Element Method, DEM) \red{la sigla ya fue definida, corregir} es una técnica numérica utilizada para modelar sistemas compuestos por un conjunto finito de partículas que interactúan entre sí mediante fuerzas de contacto. A diferencia de los métodos continuos, \red{el}\todo{un} DEM representa explícitamente cada partícula como una entidad individual, permitiendo capturar comportamientos emergentes a partir de interacciones microscópicas.
...
\red{Aquí}\todo{incorrecto, se debe referir a la ecuación}, $\mathcal{C}_i$ denota el conjunto de partículas en contacto con la partícula $i$. En implementaciones clásicas \red{del}\todo{no te refieres bien a DEM, revisa en todo el capítulo, aquí corresponde de DEM} DEM, las fuerzas externas incluyen gravedad impuesta externamente y otras perturbaciones, pero no consideran interacciones gravitatorias entre partículas del sistema.
...
El costo computacional dominante en DEM clásico proviene de la detección de contactos. Para reducirlo, se emplean estructuras auxiliares como listas de vecinos (\todo{sacar mayúscula}Verlet lists), que restringen el cálculo a partículas próximas.
