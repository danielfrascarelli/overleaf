...
\begin{itemize}
    \item \textbf{Métodos globales:} utilizan todos los puntos de referencia en cada estimación.
    \item \textbf{Métodos locales:} utilizan únicamente un subconjunto de puntos cercanos a $\mathbf{x}$.
\end{itemize}
